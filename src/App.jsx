  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="courses" className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Cursos Online</h2>
            <p className="text-muted-foreground">Aprenda com o Chef Rodrigo através dos nossos cursos</p>
          </div>
