...
const statsQuerySchema = z.object({
  ...
  period: z.enum(['day', 'week', 'month', 'year'], { message: 'Período deve ser: day, week, month ou year' }).default('week'),
  action: z.enum(['view', 'like', 'favorite', 'share', 'download'], { message: 'Ação deve ser: view, like, favorite, share ou download' }).optional(),
